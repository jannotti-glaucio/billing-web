...
import { dealerNavigation } from '../../views/dealer/_nav';
import { companyNavigation } from '../../views/company/_nav';
import { adminNavigation } from '../../views/admin/_nav';
...
export class AppSidebarNavComponent {
  ...
  constructor(
    ...
    if(session.role === UserRoles.dealer){
      this.navigation = dealerNavigation;
...
@Component({
  ...
  template: `
    ...
    <ng-template #external>
      <a [ngClass]="hasVariant() ? 'nav-link nav-link-' + link.variant : 'nav-link'" href="{{link.url}}" [target]="isExternalLink() ? link.target : ''">
        <i *ngIf="isIcon()" class="{{ link.icon }}"></i>
        {{ link.name | translate }}
        <span *ngIf="isBadge()" [ngClass]="'badge badge-' + link.badge.variant">{{ link.badge.text }}</span>
      </a>
